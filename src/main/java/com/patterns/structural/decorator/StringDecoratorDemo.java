...
public class StringDecoratorDemo {
	...
	public static void main(String[] args) {
		...
		MagicString magic = new MagicString("hello");
		System.out.println(magic + " has " + magic.getNumbersofVowels() + " vowels");
	}
...
class MagicString {
	...
	public long getNumbersofVowels() {
		return string.chars().mapToLong(c -> (char) c).filter(c -> "aieou".contains(String.valueOf(c))).count();
	}
